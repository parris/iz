...
const validators = {
  alphaNumeric: izRequiredOr(izAlphaNumeric),
  string: izRequiredOr(izString),
  between: izRequiredOr(izBetween),
  blank: izRequiredOr(izBlank),
  boolean: izRequiredOr(izBoolean),
  cc: izRequiredOr(izCc),
  date: izRequiredOr(izDate),
  decimal: izRequiredOr(izDecimal),
  email: izRequiredOr(izEmail),
  empty: izRequiredOr(izEmpty),
  equal: izRequiredOr(izEqual),
  extension: izExtension,
  fileExtension: izRequiredOr(izFileExtension),
  fileExtensionAudio: izRequiredOr(izFileExtensionAudio),
  fileExtensionImage: izRequiredOr(izFileExtensionImage),
  fileExtensionVideo: izRequiredOr(izFileExtensionVideo),
  inArray: izInArray,
  anArray: izRequiredOr(izAnArray),
  int: izRequiredOr(izInt),
  ip: izRequiredOr(izIp),
  minLength: izRequiredOr(izMinLength),
  maxLength: izRequiredOr(izMaxLength),
  multiple: izRequiredOr(izMultiple),
  number: izRequiredOr(izNumber),
  ofType: izRequiredOr(izOfType),
  phone: izRequiredOr(izPhone),
  postal: izRequiredOr(izPostal),
  required: izRequired,
  ssn: izRequiredOr(izSsn),

  addValidator: (name, validator, force) => {
    if (
